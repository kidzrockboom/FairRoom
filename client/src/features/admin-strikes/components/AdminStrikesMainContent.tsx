...
import { strikeSummary } from "@/features/admin-strikes/adminStrikesContent";

type AdminStrikesMainContentProps = {
...
export default function AdminStrikesMainContent({ student }: AdminStrikesMainContentProps) {
  return (
